...
////show image in html table
	...
	public String openViewStudentDetails(Model m) {
		...
		return "admin/view_students_details";
	}
	...
	public String openUpdateStudentPersonal(@PathVariable int s_id, Model m) {
		...
		return "admin/update_students_details";
	}
	...
	public String openShowStudentPersonal(@PathVariable("s_id") Integer s_id, Model m) {
		...
		return "admin/show_student_details";
	}
	...
	public String userPassword(Model m, HttpSession session) {
		...
		return "admin/change_student_password";
	}
	...
	@GetMapping("/filterperuser")
	public String FilterUserDetails(Model m, String keyword) {
		List<User> admin = userService.getAllUsersDetails();

		if (keyword != null) {
			m.addAttribute("admin", userService.findByKeyword(keyword));
		} else {
			m.addAttribute("admin", admin);
		}
